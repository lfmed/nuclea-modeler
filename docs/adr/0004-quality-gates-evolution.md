...
| **v0.2.1** | **ruff format** | mantido warn-only — não temos rede PyPI no ambiente atual para rodar `ruff format`, então desligamos como ambição em vez de tê-lo como dívida permanente no roadmap. |
